                    ...
                    <div class="article-left-box">
                        <div class="content">
                            ...
                            <div class="content-com course">
                                ...
                                <#list model.courseTeachers>
                                    <#items as courseTeacher>
                                        <div class="cont">
                                            <div class="img-box">
                                                <#if courseTeacher.photograph??>
                                                    <img src="${courseTeacher.photograph}"  alt="">
                                                <#else>
                                                    <img src="/static/img/widget-myImg.jpg" alt="">
                                                </#if>
                                            </div>
                                            <div class="info-box">
                                                <p class="name">教学方：<em>${courseTeacher.teacherName}</em></p>
                                                <p class="lab">${courseTeacher.position}</p>
                          ...
                          <div class="content-com about">
                            ...
                            <div class="cont cktop">
                              <div >
                                <p>
                                    <#if model.courseBase.description??>
                            ...
                            <#list model.teachplans>
                                <#items as upperTeachPlan>
                                    <#if upperTeachPlan.parentid == 0>
                                        <div class="item">
                                            <div class="title act"><i class="i-chevron-top"></i>${upperTeachPlan.pname}<span class="time">x小时</span></div>
                                            <div class="about">${upperTeachPlan.description!""}</div>
                                            <div class="drop-down" style="height: 260px;">
                                                <ul class="list-box">
                                                    <#list upperTeachPlan.teachPlanTreeNodes as lowerTeachPlan>
                                                        <li class="active">
                                                            <a href="http://www.51xuecheng.cn/course/preview/learning.html?id=${model.courseBase.id}&chapter=${lowerTeachPlan.teachplanMedia.teachplanId}" target=_blank>
                                                                ${lowerTeachPlan.pname}
                                                            </a>
                                                            <span>
                                                                ${lowerTeachPlan.timelength!""}
                                                            </span></li>
                                                    </#list>
                                                </ul>
                                            </div>
